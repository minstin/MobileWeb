...
$(document).ready(function(){
	...
	<div id = "airtext" style="padding:0px 0px 0px 0px !important;">
			<p>실시간 운항정보</p>
			<p><a href="http://localhost:8080/test/startbootstrap-business-casual-gh-pages/kimpo.jsp" style=" display:inline-block; text-align:center;-moz-border-radius:30px;-webkit-border-radius:30px;border-radius:30px;color:#ffffff;padding:0 20px;text-decoration:none;box-shadow: 0 2px 0 0 #ccc; margin:5px;  width:auto;  height:auto; line-height:30px;  font-size:17px;  background-color:#5D478B;">인천공항 & 김포공항</a>

			<a href="http://localhost:8080/test/startbootstrap-business-casual-gh-pages/jeju.jsp" style=" display:inline-block; text-align:center;-moz-border-radius:30px;-webkit-border-radius:30px;border-radius:30px;color:#ffffff;padding:0 15px;text-decoration:none;box-shadow: 0 2px 0 0 #ccc; margin-left:5px;  width:auto;  height:auto; line-height:30px;  font-size:17px;  background-color:#030303;">부산공항 & 제주공항</a></p>

</div></div>
<div id = "airtext" class="col-lg-6 text-center">
<span>부산공항(PUS)항공편 실시간 현황</span>

<p><iframe id="airair" frameborder="1" height="600" src="http://www.flightstats.com/go/weblet?guid=34b64945a69b9cac:7f3d2eef:12af6e7adc5:7ba3&amp;weblet=status&amp;action=AirportFlightStatus&amp;airportCode=PUS&amp;airportQueryType=0" width="500"></iframe></p>
</div>

<div id = "airtext" class="col-lg-6 text-center">
<span>제주공항(CJU) 항공편 실시간 현황</span>

<p><iframe id="airair" frameborder="2" height="600" src="http://www.flightstats.com/go/weblet?guid=34b64945a69b9cac:7f3d2eef:12af6e7adc5:7ba3&amp;weblet=status&amp;action=AirportFlightStatus&amp;airportCode=CJU&amp;airportQueryType=0" width="500"></iframe></p>
